...
public final class DulcetKeychainCredentialStore: DulcetProviderInstanceCredentialStoring {
    ...
    public func save(
        ...
        // The generation is a property of the record under this account id, so it is derived from
        // the record this call is about to overwrite, not from whichever id the defaults hold.
